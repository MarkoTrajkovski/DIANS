...
public class TransactionHistoryF3 implements Filter<List<ListedCompanyEntity>> {
    ...
    public TransactionHistoryF3(ListedCompanyRepository listedCompanyRepository, TransactionHistoryRepository transactionHistoryRepository) {
        this.listedCompanyRepository = listedCompanyRepository;
        this.transactionHistoryRepository = transactionHistoryRepository;
    }

    public List<ListedCompanyEntity> execute(List<ListedCompanyEntity> input) throws IOException, ParseException {
