...
public class TransactionHistoryEntity {
    ...
    private ListedCompanyEntity company;

    public TransactionHistoryEntity(LocalDate date, Double lastTransactionPrice, Double maxPrice, Double minPrice, Double averagePrice, Double percentageChange, Integer quantity, Integer turnoverBest, Integer totalTurnover) {
        this.date = date;
