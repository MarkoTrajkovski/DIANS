...
public class DataInitialize {
    ...
    private void initializeData() throws IOException, ParseException {
        ...
        Pipe<List<Stock>> pipe = new Pipe<>();
        pipe.addFilter(new FilterOne(stockRepository));
        pipe.addFilter(new FilterTwo(stockRepository, stockPriceRecordRepository));
        pipe.addFilter(new FilterThree(stockRepository, stockPriceRecordRepository));
        pipe.runFilter(null);
